...
the label boundaries and whole regions were sampled in the P56 atlas
(10\% for the former and 1\% for the latter) and then propagated to each
atlas using the transformations derived from the pairwise registrations.
Boundary points were weighted twice as those of regional points in the
