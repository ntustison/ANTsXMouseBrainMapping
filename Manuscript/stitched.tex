...
second high-resolution dataset\textsuperscript{69} comprises 88
...
algorithm available in ANTsX\textsuperscript{84}. From these two
datasets, two symmetric isotropic ANTsX templates\textsuperscript{59}
were generated analogous to the publicly available ANTsX human brain
templates used in previous research\textsuperscript{85}. Bias field
...
canonical directions were used for data augmentation in training a T2-w
