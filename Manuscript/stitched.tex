...
generated from two open datasets\textsuperscript{58,59} and single-shot
...
independent open data set\textsuperscript{60} comprising longitudinal
...
Center for Animal MRI (CAMRI) dataset\textsuperscript{58} from UNC
consists of 16 T2-weighted MRI of voxel resolution
\(0.16 \times 0.16 \times 0.16 mm^3\). The second high-resolution data
set\textsuperscript{59} comprises 88 specimens each with three spatially
...
ANTsX.\textsuperscript{48} From these two datasets, two symmetric
...
human brain templates used in previous research.\textsuperscript{56}
...
scenarios.\textsuperscript{61} It includes innovative transformation
models for biological modeling\textsuperscript{41,54} and has proven
capable of excellent performance.\textsuperscript{42,62} Various
...
technique,\textsuperscript{48} also developed by the ANTsX developers
...
nonlinearities.\textsuperscript{26,63} These augmentation techniques are
...
architecture.\textsuperscript{64} Whereas T2-weighted brain extraction
...
architecture\textsuperscript{64} was created to separate the background
...
network\textsuperscript{65} was ported to ANTsXNet and expanded to 3-D
for various super-resolution applications,\textsuperscript{66} including
...
approximation algorithm cited earlier\textsuperscript{48} (ANTsPy
...
data\textsuperscript{59} was used to create single isotropic volumes
using the B-spline fitting algorithm.\textsuperscript{48} This algorithm
is encapsulated in
