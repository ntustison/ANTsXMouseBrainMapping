...
canonical directions were used for data augmentation in creating a
...
\item
  ...
  3D atlas space requires an estimation of anatomical structure within
...
data\textsuperscript{58} which were combined to synthesize isotropic
volumetric data using the B-spline fitting
algorithm.\textsuperscript{67} This algorithm is encapsulated in
