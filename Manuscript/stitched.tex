...
community\textsuperscript{81}, comprising symmetric, multi-modal MRI and
...
order Runge-Kutta
(\texttt{ants.integrate\_velocity\_field(...)})\textsuperscript{82}.
...
system\textsuperscript{83}. By dividing the brain into anatomically or
...
variation in gene expression patterns\textsuperscript{84,85}. While deep
learning techniques have yielded robust segmentation and labeling tools
for the human brain (e.g., SynthSeg\textsuperscript{86},
ANTsXNet\textsuperscript{45}), analogous development for mouse data
(e.g., MEMOS\textsuperscript{87}) has been limited. Mouse neuroimaging
...
volumes using a B-spline fitting algorithm\textsuperscript{88}. Using
...
registration\textsuperscript{82}. At its core is the SyN
...
use a cell type clustering approach previously detailed
in\textsuperscript{49}. In short, manually dissected scRNAseq data was
used to establish the distribution of cell types present in each of the
...
B-spline scattered data approximation method\textsuperscript{88}. The
...
U-net\textsuperscript{89} architecture and hyperparameters previously
evaluated in ANTsXNet pipelines for human brain
imaging\textsuperscript{45}. This design follows the `no-new-net'
principle\textsuperscript{90}, which demonstrates that a
...
boundaries during reconstruction\textsuperscript{88}.
